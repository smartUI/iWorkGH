...
class Redis2 extends Cache {
    ...
    public function __construct($options = array()) {
        ...
        if (empty($options)) {
            $options = array(
                'host' => C('DATA_REDIS_HOST2') ? C('DATA_REDIS_HOST2') : '127.0.0.1',
                'port' => C('DATA_REDIS_PORT2') ? C('DATA_REDIS_PORT2') : 6379,
                'timeout' => C('DATA_CACHE_TIME2') ? C('DATA_CACHE_TIME2') : false,
                'persistent' => C('DATA_PERSISTENT2') ? C('DATA_PERSISTENT2') : false,
                'auth' => C('DATA_REDIS_AUTH2') ? C('DATA_REDIS_AUTH2') : false,
            );
        }
        ...
        $this->options['prefix'] = isset($options['prefix']) ? $options['prefix'] : C('DATA_CACHE_PREFIX2');
