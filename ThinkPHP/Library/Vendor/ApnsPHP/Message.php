...
class ApnsPHP_Message
{
	...
	protected $_sType; /**new add */
	protected $_sId; /**new add*/
	protected $_scId; /**new add*/
	protected $_sbcId; /**new add*/
	protected $_commentid;

	protected $_customProperties; /**< @type mixed Custom properties container. */
	...
	protected function _getPayload()
	{
		...
		if (isset($this->_sType)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['type'] = (int)$this->_sType;
		}
		if (isset($this->_sId)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['id'] = (int)$this->_sId;
		}
		if (isset($this->_scId)) {
			echo $this->_scId;
			echo $this->_sbcId;
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['cid'] = (int)$this->_scId;
		}
		if (isset($this->_sbcId)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['bcid'] = (int)$this->_sbcId;
		}
		...
		if (isset($this->_commentid)) {
			$aPayload[self::APPLE_RESERVED_NAMESPACE]['commentid'] = (string)$this->_commentid;
		}
		if (is_array($this->_aCustomProperties)) {
