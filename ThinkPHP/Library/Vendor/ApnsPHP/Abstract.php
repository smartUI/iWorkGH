...
abstract class ApnsPHP_Abstract
{
	...
	protected $_cerPass; /**< @type certificate password*/
	 ...
	 */
	public function __construct($nEnvironment, $sProviderCertificateFile, $cerPass)
	{
